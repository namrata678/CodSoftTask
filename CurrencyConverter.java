...
public class CurrencyConverter extends JFrame {
    ...
    // Real-time exchange rates fetched from a reliable API (Replace these with actual API calls)
    ...
    // For simplicity, use fixed rates here. Replace with actual API calls in a real-world scenario.
    ...
    // Task 4: Convert the input amount from the base currency to the target currency using the fetched exchange rate.
